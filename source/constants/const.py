...
TEMPLATES_PATH = './source_web/templates'
STATIC_FILE_PATH = './source_web/static'
...
EQUITY_BASKET = './source/data/basket/equity_basket.csv'
INDEX_OPTIONS_BASKET = './source/data/basket/index_options_basket.csv'
STOCK_OPTIONS_BASKET = './source/data/basket/stock_options_basket.csv'
FUTURES_BASKET = './source/data/basket/futures_basket.csv'
