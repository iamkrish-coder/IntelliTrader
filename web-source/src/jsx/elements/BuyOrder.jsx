    ...
    return (
        ...
        <div className="card price-list">
            <div className="card-header border-0 p-3">
                <div>
                    <h4 className="text-warning card-title">Buy Order</h4>
                </div>
                <Dropdown className="custom-dropdown">
                    <Dropdown.Toggle as="div" className="btn sharp btn-warning tp-btn i-false">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" version="1.1"><g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd"><rect x="0" y="0" width="24" height="24"></rect><circle fill="#fd5353" cx="12" cy="5" r="2"></circle><circle fill="#fd5353" cx="12" cy="12" r="2"></circle><circle fill="#fd5353" cx="12" cy="19" r="2"></circle></g></svg>
                    </Dropdown.Toggle>
            ...
            <div className="card-footer text-center py-3 border-0">
                <Link to={"#"} className="btn-link text-warning">Show more <i className="fa fa-caret-right text-warning" /></Link>
            </div>
        </div>
